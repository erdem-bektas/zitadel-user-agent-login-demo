...
const projectAudienceScope = import.meta.env.VITE_ZITADEL_API_PROJECT_ID
  ? ` urn:zitadel:iam:org:project:id:${import.meta.env.VITE_ZITADEL_API_PROJECT_ID}:aud`
  : "";
...
const oidcConfig: AuthProviderProps = {
  ...
  response_type: "code",
  scope: `openid profile email offline_access${projectAudienceScope}`,
